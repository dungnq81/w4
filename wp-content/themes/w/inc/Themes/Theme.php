...
if ( ! class_exists( 'Theme' ) ) {
	class Theme {
		...
		public function after_setup_theme() {
			 ...
			 */
			load_theme_textdomain( 'w', trailingslashit( WP_LANG_DIR ) . 'themes/' );
			load_theme_textdomain( 'w', get_stylesheet_directory() . '/languages' );
		...
		public function enqueue_scripts() {
			...
			wp_localize_script( 'jquery-core', 'W', $l10n );
