		...
		public function deferred_scripts() {
			...
			if ( $fb_appid && $fb_pageid && $fb_livechat && ! is_customize_preview() ) {
				if ( $fb_pageid ) {
					...
					$_fb_message = __( 'If you need assistance, please leave a message here. Thanks', 'w' );
			...
			if ( $zalo_oaid ) {
				if ( $zalo_livechat ) {
					echo '<div class="zalo-chat-widget" data-oaid="' . $zalo_oaid . '" data-welcome-message="' . __( 'Rất vui khi được hỗ trợ bạn.', 'w' ) . '" data-autopopup="0" data-width="350" data-height="420"></div>';
				}
